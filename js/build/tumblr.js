...
var _AsideJs = require('./Aside.js');

var _AsideJs2 = _interopRequireDefault(_AsideJs);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        'div',
        { className: 'app' },
        _react2['default'].createElement(_AsideJs2['default'], props.aside),
        _react2['default'].createElement(
          'main',
          { id: 'main', className: 'main', tabIndex: '-1' },
          _react2['default'].createElement(_IndexJs2['default'], props.main)
        )
      );
    }
  }], [{
...
},{"./Aside.js":3,"./Index.js":4,"jquery":8,"react":163}],2:[function(require,module,exports){
'use strict';
  ...
  function Tags() {
    ...
    this.render = function () {
      ...
      if (tags.length > 0) {
        return _react2['default'].createElement(
          'p',
          { className: 'article__meta__item article__meta__item--tags' },
...
var Source = (function (_Component2) {
  ...
  function Source() {
    ...
    this.render = function () {
      var source = _this2.props.source;

      if (source) {
        return _react2['default'].createElement(
          'p',
          { className: 'article__meta__item article__meta__item--source' },
          _react2['default'].createElement(
            'q',
            { cite: source },
            _react2['default'].createElement(
    ...
    this.render = function () {
      ...
      switch (attrs.type) {
        ...
        case 'link':
          ...
          content = _react2['default'].createElement(_PostJs2['default'].links, props);
          break;
        ...
        case 'text':
          ...
          content = _react2['default'].createElement(_PostJs2['default'].text, props);
          break;
...
var Article = (function (_Component5) {
  _inherits(Article, _Component5);
...
},{"./Post.js":5,"react":163}],3:[function(require,module,exports){
'use strict';
...
var Aside = (function (_Component) {
  ...
  function Aside() {
    ...
    this.handleChange = function (e) {
      _this.props.onUserInput(_this.refs.filterTextInput.getDOMNode().value);
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            'Search',
            _react2['default'].createElement('input', { type: 'search', id: 'search', placeholder: 'Search Post Type', value: filterText, ref: 'filterTextInput', onChange: _this.handleChange, list: 'postType', className: 'awesomplete search__input' }),
            _react2['default'].createElement(
              'datalist',
              { id: 'postType' },
...
var _ArticleJs2 = _interopRequireDefault(_ArticleJs);
      ...
      return _react2['default'].createElement(
        ...
        posts.map(function (post, index) {
          ...
          if (post.type.indexOf(filterText) === -1) {
            ...
            return _react2['default'].createElement(_ArticleJs2['default'], props);
          }
        })
      );
    };
...
},{"./Article.js":2,"react":163}],5:[function(require,module,exports){
"use strict";
    ...
    value: function render() {
      ...
      return _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          ...
          _react2["default"].createElement("img", { "data-src": photos.url, alt: "", width: photos.width, height: photos.height, "data-action": "zoom" }),
...
var Text = (function (_Component2) {
  ...
  _createClass(Text, [{
    ...
    key: "render",
    value: function render() {
      return _react2["default"].createElement("div", { className: "text", dangerouslySetInnerHTML: this.rawMarkup() });
    }
  }]);
...
var Links = (function (_Component3) {
  _inherits(Links, _Component3);
  ...
  _createClass(Links, [{
    ...
    value: function render() {
      ...
      var excerpt = _props2.excerpt;

      return _react2["default"].createElement(
        "div",
        { className: "link" },
        photos && _react2["default"].createElement("img", { "data-src": photos[0].original_size.url, alt: "", width: photos[0].original_size.width, height: photos[0].original_size.height, "data-action": "zoom", className: "link__thumbnail" }),
        _react2["default"].createElement(
          "a",
...
var _moduleApp = require('./module/App');

var _moduleApp2 = _interopRequireDefault(_moduleApp);

_react2['default'].render(_react2['default'].createElement(_moduleApp2['default'], null), app);

},{"./module/App":1,"react":163}],7:[function(require,module,exports){
